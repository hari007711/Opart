...
// //   useEffect(() => {
// //     if (timeLeft === 0) {
// //       setShowCheck(true); // show check first
// //       const timer = setTimeout(() => {
// //         setShowCheck(false); // auto hide after 2s
// //       }, 2000);
...
// //                       <span className="text-md text-black font-semibold">
// //                         {quantity}{" "}
// //                         <span className="font-medium text-xs">kg</span>
// //                       </span>
// //                     </div>
...
// //                       onConfirm={() => console.log("Confirmed:", quantity)}
...
//   // Auto-hide checkImg after 2 seconds when timer completes
//   useEffect(() => {
...
//   // Determine what to show in timer button
//   const shouldShowTimer = prepStatus === "to-prep" || prepStatus === "in-prep";
//   const shouldShowNothing =
//     prepStatus === "available" ||
//     (!shouldShowTimer && !timeLeft && !showCheckImg);
...
const PrepItemCard: React.FC<PrepItemCardProps> = ({
  ...
  // const { triggerRefreshStatus } = useRefreshStore();
  ...
  //     // 🔥 trigger refresh here after success
  //     triggerRefresh();
