...
export default function StepIndicator() {
  ...
  const { selectedItemsCount } = usePrintLabelStore();
  ...
  useEffect(() => {
    if (
      ...
      // Focus the search input when the Print Labels or Search screen is displayed
        ...
        <div className="flex items-center justify-between">
                    ...
                    {currentStepData.name == "Print Labels" && (
                      <div style={{ position: "relative" }} className="ml-5">
                        <Input
                          ...
                          // className="w-100 h-10 rounded-none pr-3 pl-12 focus:ring-blue-500 focus:border-blue-500"
                          value={searchTerm}
                ...
                <div className="flex ml-3">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting dayCount to: Daily Count");
                      ...
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting dayCount to: Weekly Count");
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting location to: All Locations");
                          setSelectedLocation("");
                        }}
                      >
                        All Locations
                      ...
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting location to: Freezer");
                      ...
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting location to: Storage Room 1");
                      ...
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting location to: Storage Room 2");
                      ...
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting location to: Refrigerator");
                      ...
                      <DropdownMenuItem
                        onSelect={() => {
                          console.log("Setting location to: Pantry");
            ...
            <div className="flex items-center justify-start gap-5">
              ...
              <button
                className={`px-4 py-3 text-white rounded-md flex items-center gap-3 transition-colors ${
                  selectedItemsCount === 0
                    ? "bg-gray-400"
                    : "bg-[#1f3678] hover:bg-[#1a2e66] cursor-pointer"
                }`}
          ...
          {currentStepData.name === "Today's Forecast" ? (
            <div className="flex items-center space-x-3">
              ...
              >
                <span>
                  <Image src={Insights} alt="Insights" height={25} width={25} />
                </span>
                Insights
              </button>
              <button
                  ...
                  >
                    <span>
                      {status === "modify" ? (
                        ...
                        <Image src={Edit2} alt="Edit" height={25} width={25} />
                      )}
                    </span>
                    Modify
                  </button>
                    ...
                    currentStepData.name !== "Search" && (
                      <div className="flex items-center space-x-3">
                        <button
                          ...
                          className="px-4 py-2 text-lg text-gray-700 rounded-md hover:bg-gray-200 flex items-center gap-3"
                        >
                          <span>
                        ...
                        <button
                          ...
                          className="px-4 py-2 text-gray-700 rounded-md hover:bg-gray-200 flex items-center gap-3"
                        >
                          <span>
